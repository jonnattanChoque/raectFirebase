...
export const Register = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      await firebaseDB.register(email, password);
      setEmail('');
      setPassword('');
      setConfirmPassword('');
      history('/billslist');
    ...
    <>
      ...
      <Header>
        <ContenedorHeader>
          ...
          <div>
            <Button to="/login" primario> Iniciar sesión </Button>
          </div>
        </ContenedorHeader>
      </Header>
      <Formulario onSubmit={handleSubmit}>
        ...
        <Input type="password" placeholder="Repetir contraseña" name="confirmPassword" 
        value={confirmPassword} onChange={handleChange} />
        <ContenedorBoton>
          <Button as="button" primario="true" type="submit">Registrarse</Button>
        </ContenedorBoton>
      </Formulario>
